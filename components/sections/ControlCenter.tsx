import { Lock, Unlock, Check, Coins, FileText, Share2, Eye } from "lucide-react";
        ...
        <div className="mt-12 flex items-center justify-center relative px-4 md:px-20 py-8 gap-12">
            ...
            <div className="flex flex-col items-center gap-4">
                <div className="size-16 rounded-2xl bg-[#151A17] border border-white/10 flex items-center justify-center relative">
                    ...
                    <div className="absolute -top-2 -right-2 bg-[#BC5FEF] text-[10px] text-white px-2 py-0.5 rounded-full font-bold">Encrypted</div>
                </div>
        ...
        <div className="mt-auto pt-10">
            <div className="rounded-xl bg-[#111614] border border-white/5 overflow-hidden p-2 space-y-2">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 transition-colors cursor-pointer group">
                    ...
                    <div>
                        <div className="text-xs font-bold text-white group-hover:text-[#BC5FEF] transition-colors">Contract.pdf</div>
                        <div className="text-[10px] text-gray-500">2.4 MB • Legal Agreement</div>
                    </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 transition-colors cursor-pointer group">
                    ...
                    <div>
                        <div className="text-xs font-bold text-white group-hover:text-[#BC5FEF] transition-colors">Transaction Hash</div>
                        <div className="text-[10px] text-gray-500">Etherscan • 0x4a...92b</div>
                    </div>
                    <Eye className="size-4 text-gray-600 ml-auto group-hover:text-white" />
                </div>
            ...
            <div className="container mx-auto max-w-6xl px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                        A strategy game where your move is the truth. Stake tokens, vote privately, and reveal to win.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <BentoCard className="md:col-span-2 min-h-[360px] flex flex-col items-center justify-center">
                        <div className="text-center z-10">
                            <h3 className="text-2xl font-semibold text-[#BC5FEF] mb-2">Commit-Reveal Voting</h3>
                            <p className="text-gray-400 text-sm">Votes are encrypted. No copying, no bribery. Reveal your decision later to unlock rewards.</p>
                        </div>
                    ...
                    <BentoCard glowPosition="bottom" className="min-h-[400px]">
                        <div className="mb-4">
                            <h3 className="text-xl font-semibold text-white mb-2">Stake to Judge</h3>
                            <p className="text-gray-400 text-sm">Skin in the game. Stake tokens to increase your chances of being selected for high-value disputes.</p>
                        </div>
                        <StakingUI />
                    </BentoCard>
                    ...
                    <BentoCard glowPosition="bottom" className="min-h-[400px]">
                        <div className="mb-4">
                            <h3 className="text-xl font-semibold text-white mb-2">Zero Legalese</h3>
                            <p className="text-gray-400 text-sm">No complex legal jargon. Evidence is presented in simple, organized cards. Justice is just a swipe away.</p>
                        </div>
                        <EvidenceUI />
                    </BentoCard>
